...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B71Xrhav.mjs");
...
const manifest = {
  "f4b502376c2aad1714da6efc58f06e92e5a7d10491fcad1eb6ff917c0139435c": {
    functionName: "getSubmissions_createServerFn_handler",
    importer: () => import("./admin.functions-hVydF-fo.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D2mCEL91.mjs"),
    import("./start-Bzc-qdlF.mjs"),
